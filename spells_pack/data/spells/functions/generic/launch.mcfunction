...
execute store result entity @s Motion[1] double 0.002 run scoreboard players get %dx g_vec
execute store result entity @s Motion[2] double 0.002 run scoreboard players get %dx g_vec
